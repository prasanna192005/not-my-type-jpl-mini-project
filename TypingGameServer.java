...
public class TypingGameServer {
    ...
    private static final String[] JAVA_PARAGRAPHS = {
        "Java is an object-oriented programming language developed by James Gosling at Sun Microsystems in 1995. Its motto 'Write Once, Run Anywhere' highlights its platform independence through the Java Virtual Machine.",
    ...
    public static void main(String[] args) {
        try {
            ...
            while (true) {
                ...
                // Send result and winner
                String resultMessage = String.format(
                    "Player 1: WPM = %.2f, Accuracy = %.2f%%\nPlayer 2: WPM = %.2f, Accuracy = %.2f%%\nWinner: %s",
                    player1WPM, player1Accuracy, player2WPM, player2Accuracy, winner
                );
                player1Writer.println("RESULT:" + resultMessage);
                player2Writer.println("RESULT:" + resultMessage);
